 ...
 */
!function(o, t) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : o.Jump = t()
}(this, function() {
    "use strict";
    var v = function(o, t, e, n) {
        return (o /= n / 2) < 1 ? e / 2 * o * o + t : -e / 2 * (--o * (o - 2) - 1) + t
    }
    ...
    return function() {
        ...
        function m(o) {
            ...
            s = u(a = o - t, n, c, f),
            window.scrollTo(0, s),
            a < f ? window.requestAnimationFrame(m) : (window.scrollTo(0, n + c),
            e && d && (e.setAttribute("tabindex", "-1"),
            e.focus()),
            "function" == typeof l && l(),
            t = !1)
        }
